...
public class MarketConstants {
    ...
    public static final String FIRST_ADD_BETS_INFO = "Aby opublikować rynek dodaj do niego zakłady";
    public static final String MARKET_EXISTING_INFO = "Rynek o tym tytule już istnieje";
    public static final String BET_EXISTING_INFO = "Zakład o tej nazwie już istnieje dla tego rynku";
